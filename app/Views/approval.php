    ...
    <div class="card-body h-full">
        ...
        <div class="doc">
            <div class="row">
                ...
                <div class="col-6">
                    <center>
                        <div class="d-flex align-items-center p-3 mb-3" style="height: 150px;border:solid 1px #000;width:350px">
                            Comment Catatan : <textarea style="background-color:transparent;border:none" name="" id="" cols="20" rows="5"></textarea>
                        </div>
